select *
from DA_Portfolio_Project_1..CovidDeaths
order by 3,4
...
--alter table DA_Portfolio_Project_1..CovidDeaths add constraint df_a default NULL for new_deaths

update D_Portfolio_Project_1..CovidDeaths 
set  total_cases = NULL
where total_cases = 0

update DA_Portfolio_Project_1..CovidDeaths 
set  new_cases = NULL
where new_cases = 0
...
--convert(int, name)
from DA_Portfolio_Project_1..CovidVaccinations vac
join DA_Portfolio_Project_1..CovidDeaths dea
